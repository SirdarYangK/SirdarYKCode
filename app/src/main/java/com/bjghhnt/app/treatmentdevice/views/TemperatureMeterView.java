 ...
 */
public class TemperatureMeterView extends View {
	...
	public TemperatureMeterView(Context context) {
		super(context, null);
	}

	public TemperatureMeterView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public TemperatureMeterView(Context context, AttributeSet attrs, int defStyleAttr) {
